...
public class BrandController extends HttpServlet {
	...
	private void searchBrand(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("message", message);
		RequestDispatcher rd=request.getRequestDispatcher("view-one-brand.jsp");
		rd.forward(request, response);
	}
	...
	private void viewAll(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String message= "";
		try {
			List<Brand>brandlist=service.getAllBrand();
			if(brandlist.isEmpty()) {
				message="Empty Brand List";
